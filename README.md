...
![Основной прототип](TZ/template.jpg)

**Главная страница**

![Главная страница](TZ/main.JPG)

**Результаты поиска**

![Результат поиска](TZ/result.jpg)

**Статья**

![Статья](TZ/article.jpg)

**Регистрация**

![Регистрация](TZ/registration.JPG)

**О проекте**

![О проекте](TZ/about.JPG)
