...
![Основной прототип](ТЗ/template.jpg)

**Главная страница**

![Главная страница](ТЗ/main.JPG)

**Результаты поиска**

![Результат поиска](ТЗ/result.jpg)

**Статья**

![Статья](ТЗ/article.jpg)

**Регистрация**

![Регистрация](ТЗ/registration.JPG)

**О проекте**

![О проекте](ТЗ/about.JPG)
