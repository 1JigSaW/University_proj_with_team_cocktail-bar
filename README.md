...
**Форма поиска по сайту. Находится на все страницах, в шапке сайта после блока "О проекте".**
...
* Сценарий поиска. Добавляет запись в соответствующую форму,обращается к БД с таблицей "Статьи" и ищет слово/набор слов, введенный в форме, который будет совпадать с данными в таблице. Если такое(ой) слово/набор слов был найден, то он приводит статью, содержащую это(т) слово/набор слов. Если не находит введенные слова/набор слов, выводит страницу, сообщающую об этом.
