...
=======
-- Время создания: Май 18 2019 г., 21:37
>>>>>>> 99b216caa2ad3fa14ef4121bb0a114060cb275ef
...
(11, 'Пина колада', 40, 'крепкоалкогольный');
...
(14, 11, 'Пина Колада (Pina Colada) – сладкий карибский коктейль. Его название переводится как «фильтрованный ананас». Когда-то, так называли свежий ананасовый сок, который подавали процеженным (colada) в отличие от не процеженного (sin colar). Позже к соку добавили ром и сахар. Наконец, в середине прошлого века в одном из пуэрториканских баров родился рецепт коктейля Пина Колада (Pina Colada), который приобрел огромную популярность и стал гордостью Пуэрто Рико. Основными ингредиентами коктейля являются ром, кокосовый ликер и ананасовый сок.', 'https://lifeglobe.net/blogs/details?id=642');
...
(36, 'Ананасовый сок', 'drink'),
(37, 'Кокосовые сливки', 'product'),
(38, 'Взбитые сливки', 'product');
